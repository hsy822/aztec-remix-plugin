  ...
  return {
    ...
    server: {
      ...
      headers: {
        ...
        // 'Cross-Origin-Embedder-Policy': 'credentialless' // require-corp 대신 사용 가능하며 아래 cors 정책 삭제 해도 됨
      },
      cors: {
        // origin: "https://remix.ethereum.org/", // Remix 도메인만 허용
      ...
      fs: {
        allow: [
          ...
          './src', // src 폴더에서 fs 사용 가능하도록 허용
          './src/components', // components 폴더에서도 허용
        ],
      },
    },
    plugins: [
      ...
      // }),
      bundlesize({
        limits: [{ name: 'assets/index-*', limit: '3000kB' }],
      }),
    ],
    define: {
